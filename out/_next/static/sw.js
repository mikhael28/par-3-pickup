...
/******/ 	return __webpack_require__(__webpack_require__.s = "nnoy");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./src/sw/utils/deleteEntriesForCache.ts



function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = deleteEntriesForCache_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function deleteEntriesForCache_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return deleteEntriesForCache_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return deleteEntriesForCache_arrayLikeToArray(o, minLen); }

function deleteEntriesForCache_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

var deleteEntriesForCache_deleteEntriesForCache = function deleteEntriesForCache(CACHE_NAME) {
  return /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
...
/* harmony default export */ var utils_deleteEntriesForCache = (deleteEntriesForCache_deleteEntriesForCache);
...
// CONCATENATED MODULE: ./src/sw/utils/getBuildManifest.ts
...
var getBuildManifest_getBuildManifest = function getBuildManifest() {
  var manifest = self.__BUILD_MANIFEST;
  return Object.entries(manifest).reduce(function (manifest, _ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        page = _ref2[0],
        assets = _ref2[1];

    return _objectSpread(_objectSpread({}, manifest), {}, _defineProperty({}, page, assets.map(function (url) {
      return "/_next/".concat(url);
    })));
  }, {});
};

/* harmony default export */ var utils_getBuildManifest = (getBuildManifest_getBuildManifest);
...
// CONCATENATED MODULE: ./src/sw/utils/getBuildManifestPages.ts



var getBuildManifestPages_getBuildManifestPages = function getBuildManifestPages() {
  var _getBuildManifest = utils_getBuildManifest(),
      sortedPages = _getBuildManifest.sortedPages,
      __rewrites = _getBuildManifest.__rewrites,
      manifest = _objectWithoutProperties(_getBuildManifest, ["sortedPages", "__rewrites"]);
...
/* harmony default export */ var utils_getBuildManifestPages = (getBuildManifestPages_getBuildManifestPages);
...
// CONCATENATED MODULE: ./src/sw/utils/getRequestedPageFromURL.ts


var getRequestedPageFromURL_getRequestedPageFromURL = function getRequestedPageFromURL(url) {
  var _URL = new URL(url),
      pathname = _URL.pathname;

  var manifest = utils_getBuildManifestPages();
  /*
...
/* harmony default export */ var utils_getRequestedPageFromURL = (getRequestedPageFromURL_getRequestedPageFromURL);
// CONCATENATED MODULE: ./src/sw/utils/router.ts
...
var router_Router = /*#__PURE__*/function () {
  function Router(cacheName) {
    ...
    _defineProperty(this, "_cacheName", void 0);

    _defineProperty(this, "_ignoredRoutes", void 0);

    _defineProperty(this, "_workboxRouter", void 0);

    _defineProperty(this, "handleOfflineDocumentFetch", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(event) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                requestedPage = utils_getRequestedPageFromURL(url);
              ...
              case 4:
                _context.next = 6;
                return self.caches.open(cacheNames_cacheNames.precache);
    ...
    _defineProperty(this, "handleFetch", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2(event) {
    ...
    this._workboxRouter = new Router_Router();
  ...
  _createClass(Router, [{
    ...
    value: function register() {
      ...
      this._workboxRouter.registerRoute(construct_construct(RegExpRoute_RegExpRoute, args));
    }
  }, {
    key: "_init",
...
// CONCATENATED MODULE: ./src/sw/index.ts
 ...
 */
importScripts("/_next/static/".concat("6qLfzY6y8mViSgHBNJOxp", "/_buildManifest.js"));
/*
...
var CACHE_NAME_RUNTIME = cacheNames_cacheNames.runtime;
/*
 * Generate documents to pre-fetch
 */

var sw_manifest = utils_getBuildManifest();
var buildManifestPages = utils_getBuildManifestPages();
var sw_revision = "".concat(Date.now());
/*
...
var documentFilesToCache = buildManifestPages.reduce(function (pages, name) {
  return [].concat(_toConsumableArray(pages), _toConsumableArray(sw_manifest[name]));
}, []).map(function (url) {
  return {
    url: url,
    revision: null
...
precacheAndRoute([].concat(_toConsumableArray([{'revision':null,'url':'/_next/static/6qLfzY6y8mViSgHBNJOxp/_buildManifest.js'},{'revision':null,'url':'/_next/static/6qLfzY6y8mViSgHBNJOxp/_ssgManifest.js'},{'revision':null,'url':'/_next/static/chunks/15.c8afba9845f3c6502730.js'},{'revision':null,'url':'/_next/static/chunks/16.96728c889bc467fc7c30.js'},{'revision':null,'url':'/_next/static/chunks/17.0ce83626c738f6489d95.js'},{'revision':null,'url':'/_next/static/chunks/18.2b380655299c2ea67780.js'},{'revision':null,'url':'/_next/static/chunks/19.df0b5c769f6c95ef6e5c.js'},{'revision':null,'url':'/_next/static/chunks/20.968575baf95bb16e3650.js'},{'revision':null,'url':'/_next/static/chunks/3621d91f618ab6f83982e75b2b4ad3ed3fadfee1.5ac8132c8d82b64ecfb2.js'},{'revision':null,'url':'/_next/static/chunks/b2add8f05006db528c33992940f9d3e1eb1a4ff7.94d59c293c1777718dc9.js'},{'revision':null,'url':'/_next/static/chunks/c4c666b3b27119654a41e65e737b5764a4138f15.d3fb871d407519868dce.js'},{'revision':null,'url':'/_next/static/chunks/f8449ed90a4b707cb64da186ccf337afaf846fa6.c29c3466395db82b3a3a.js'},{'revision':null,'url':'/_next/static/chunks/framework.1ca34f6898d8c56e0ffd.js'},{'revision':null,'url':'/_next/static/chunks/main-d76056a03e1a825352c6.js'},{'revision':null,'url':'/_next/static/chunks/pages/[page]-fd09f7ba141aafae4842.js'},{'revision':null,'url':'/_next/static/chunks/pages/_app-32e5763c3a6915ab3b43.js'},{'revision':null,'url':'/_next/static/chunks/pages/_error-eaf28c937eb2a42213db.js'},{'revision':null,'url':'/_next/static/chunks/pages/index-4a724bd344264b51a6da.js'},{'revision':null,'url':'/_next/static/chunks/pages/matchmaking-0dd7d8ca5b6c86aeae57.js'},{'revision':null,'url':'/_next/static/chunks/pages/profile-ef48655da2fdb9428937.js'},{'revision':null,'url':'/_next/static/chunks/pages/stakes-29348beef51272ee99ba.js'},{'revision':null,'url':'/_next/static/chunks/polyfills-28a453ab78bd7ac4fdb9.js'},{'revision':null,'url':'/_next/static/chunks/webpack-340bf00d22a8b2b4ff33.js'},{'revision':null,'url':'/_next/static/css/1635162bdf5326be70cc.css'},{'revision':null,'url':'/_next/static/css/8a33b0314055cb0e678e.css'},{'revision':null,'url':'/_next/static/css/b26d10f17e300a85953f.css'},{'revision':null,'url':'/_next/static/css/b9bee23cc5e655934951.css'},{'revision':'88d3f4a4c9b12343322b7ee2ba6651fa','url':'/favicon.ico'},{'revision':'37cc75213b3655a616457b094b6b9718','url':'/logo256.png'},{'revision':'cd336b20dac4c032c86c6df8dcd1ac50','url':'/logo512.png'},{'revision':'9208588d054e007f59f7377e466bdf41','url':'/manifest.json'},{'revision':'c0cdefaba60ebadd8409b6b46824f8c1','url':'/robots.txt'}] || []), _toConsumableArray(documentURLsToCache), _toConsumableArray(documentFilesToCache)));
/*
 * On re-deploy delete all cached runtime requests.
 */

self.addEventListener('activate', function (event) {
  event.waitUntil(utils_deleteEntriesForCache(CACHE_NAME_RUNTIME));
});
...
var router = new router_Router(CACHE_NAME_RUNTIME);
router.ignoredRoutes = /\/webpack|\/react-refresh/;
router.setRoute(/\/api\//, NetworkFirst_NetworkFirst);
router.setRoute(/\/static\/|\.(js|css)/, CacheFirst_CacheFirst);
router.setDefault(StaleWhileRevalidate_StaleWhileRevalidate);
/* harmony default export */ var sw = __webpack_exports__["default"] = ({});
